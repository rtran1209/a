...
<head>
  ...
  <style type="text/css">
    ...
    .container { width: 760px; margin: 40px auto; text-align: left;  }
    ...
    input[type=text] { width: 640px; }
    
    .footer { position: relative; }
    .footer p { margin:0; position: absolute; bottom: 10px;  right: 10px;}
  </style>
</head>
<body>
  ...
  <div class="container">
    ...
    <div class="main">
      ...
      <form action="/study/no-js" method="get" id="unblocker-form">
        <p>
          URL: 
	...
	<script>
		...
		$('unblocker-form').onsubmit = function(){
			...
			window.location.pathname = "/study/" + url;
			return false;
		}
